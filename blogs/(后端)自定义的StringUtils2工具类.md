>根据指定的换行符去除String中的空行及前后空格，效果见博文末尾。
...
```
>效果截图：
![image.png](http://upload-images.jianshu.io/upload_images/9541455-30a43d516781f1ff.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
